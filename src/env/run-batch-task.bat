...
set cp=%cp%;"%dir%lib\commons-logging.jar"
set cp=%cp%;"%dir%lib\dl.util.concurrent.jar"
set cp=%cp%;"%dir%lib\glassfish-corba-internal-api.jar"
set cp=%cp%;"%dir%lib\glassfish-corba-orb.jar"
set cp=%cp%;"%dir%lib\glassfish-corba-omgapi.jar"
set cp=%cp%;"%dir%lib\httpclient.jar"
set cp=%cp%;"%dir%lib\httpcore.jar"
set cp=%cp%;"%dir%lib\icu4j.jar"
set cp=%cp%;"%dir%lib\jackrabbit-webdav.jar"
set cp=%cp%;"%dir%lib\jh.jar"
set cp=%cp%;"%dir%lib\log4j.jar"
set cp=%cp%;"%dir%lib\log4j-api.jar"
set cp=%cp%;"%dir%lib\log4j-core.jar"
set cp=%cp%;"%dir%lib\mail.jar"
set cp=%cp%;"%dir%lib\mailapi.jar"
set cp=%cp%;"%dir%lib\pfl-basic.jar"
set cp=%cp%;"%dir%lib\pfl-tf.jar"
